...
const BUSINESS_TYPES_LABEL = {
 FNB: ' F&B', Retail: ' Retail', Jasa: ' Jasa',
...
export default function MembersPage() {
 ...
 <span style={{ fontSize:12, fontWeight:700, padding:'3px 12px', borderRadius:20, background:tier.bg, color:tier.color, border:`1px solid ${tier.border}` }}>
 {tier.emoji} Tier {tier.name}
 {tier.name==='Regular' && <span style={{ fontSize:10, color:tier.color, marginLeft:4 }}>(belanja ≥ Rp 200rb → Bronze)</span>}
 </span>
 </div>
 </div>
