...
const ReportsPage = () => {
  const { transactions, products, members, settings, navigate, refundTransaction } = useApp()
...
<div class="footer">
  ...
  const stats = useMemo(() => {
    ...
    return { total, profit, totalOrders:completed.length, revGrowth, orderGrowth, categoryRevenue, maxCatRev, topProducts, maxProdRev, kasirPerf }
